...
\begin{table}[t]
  ...
  \begin{tabular}{lrrrr}
    ...
    \midrule
    LRU     & 1.57  & 3.43   & 250{,}603 & 56\,B \\
    FIFO    & 1.39  & 3.30   & 265{,}726 & 56\,B \\
    LFU     & 21.21 & 181.01 &  99{,}361 & 56\,B \\
    Random  & 3.29  & 15.82  & 188{,}012 & 56\,B \\
    \textbf{GDSF} & \textbf{10.97} & \textbf{27.10} & \textbf{57{,}882} & \textbf{56\,B} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\texttt{EntryMetadata} record (56~B/entry; see the ``Memory/entry''
column of Table~\ref{tab:latency}), so cost-awareness is obtained
without a memory penalty.
